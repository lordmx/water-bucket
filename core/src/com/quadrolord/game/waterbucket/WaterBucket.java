package com.quadrolord.game.waterbucket;
...
import com.quadrolord.game.waterbucket.screen.GameScreen;

public class WaterBucket extends ApplicationAdapter {
	...
	public void create () {
		mGame = new Game();
		mFps = new FPSLogger();
		mScreen = new GameScreen(this, mGame);
	}
